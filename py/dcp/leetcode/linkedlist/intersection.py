...
def build_list(list1 : list[int], list2 : list[int], common : list[int] ) -> tuple[ListNode, ListNode, ListNode]:
    
    headA, tailA = to_list(list1)
    headB, tailB = to_list(list2)

    tail, _ = to_list(common)
