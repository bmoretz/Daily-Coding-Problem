...
from py.problems.arr import majority_element
class Test_LettersNumbers2(unittest.TestCase):
...
from py.problems.arr import smallest_k1
...
from py.problems.arr import smallest_k2
class Test_SmallestK1(unittest.TestCase):
...
import random
from py.problems.arr import smallest_k3
class Test_SmallestK3(unittest.TestCase):
